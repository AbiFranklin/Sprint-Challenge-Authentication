...
Sessions are helpful because they can store more information, meaning fewer calls to the server and they delete when the client closes.

1. What does bcrypt do to help us store passwords in a secure manner.

brypt hashes your password, providing a more secrue password than the password actually provided by the user.

1. What does bcrypt do to slow down attackers?

Generates a longer, more complex pass word.
